    ...
    <section id="visualizar-fichas">
      <div class="align-titulo">
        <div class="grid-titulo">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/Fisio/assets/grafico.png" alt="">
      ...
      <div id="bloco_fichas">
              <div class="barra-topo-tabela-atletas align-end">
                <div class="barra-topo-tabela-atletas ">
                  <input class="form-control-plaintext" type="text" placeholder="Pesquisar">
                  <div>
                    <a href="/">
                      <img src="<?php echo get_stylesheet_directory_uri(); ?>/Fisio/assets/search.svg" alt="">
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="fichas_view " id='id1' onclick="Preview_ficha(id1)">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/Captacao/assets/fichaSearch.png" alt="" class="img_ficha">
                  <div class="info">
                    <h2>N° da ficha:1</h2>
                    <span>Nome: Juca</span>
